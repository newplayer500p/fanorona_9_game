    ...
    >
      <View style={styles.header}>
        <TouchableOpacity
          style={[
            styles.headerButton,
            { borderColor: theme.backButtonBorderColor }
          ]}
          ...
          <View
            style={[
              styles.modeBadge,
              {
                ...
                borderColor: theme.modeBadgeBackground
              }
            ]}
          >
            <Text
              style={[
                ...
                { color: theme.modeBadgeTextColor }
              ]}
            >
              {modeBadgeLabel}
            </Text>
      ...
      >
        ...
        {hintText ? (
          <Text style={[styles.hintText, { color: theme.hintTextColor }]}>
            {hintText}
          </Text>
        ) : null}
      </ScrollView>
